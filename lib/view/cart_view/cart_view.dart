        ...
        body: GetBuilder<NewCartController>(builder: (provider) {
          ...
          if (items.isEmpty) {
            ...
            provider.cartItems.map((e) {
              ...
              finalPrice +=
                  e.quantity! * Utils.convertStringIntoInt(e.finalPrice!);
            }).toList();
            return ListView(
              children: [
                5.h.heightBox,
                      ...
                      child: Column(
                        children: [
                          ...
                          Expanded(
                            child: Center(
                              child: customText(
                                  "Add New Address", GetTextTheme.fs14_medium),
                            ),
                          )
                        ],
                      ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      customText(
                          "Price Details (${provider.cartItems.length} items)",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          customText(
                              "- $totalDiscount.00", GetTextTheme.fs14_regular)
                        ],
                      ),
                      const Divider(
                        color: Colors.grey,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          customText("$finalPrice.00", GetTextTheme.fs14_bold),
                        ],
                      ),
                    ],
                  ),
