...
class AddressTiel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<UserAddressController>(builder: (controller) {
      ...
      var pinController = Get.find<AppData>().servicesArea;
      bool isPincodeFind = pinController
          .any((element) => element.postalCode == address.pincode.toString());
          ...
          child: Column(
            ...
            children: [
              ...
              customText(
                  ...
                  GetTextTheme.fs14_regular.copyWith(
                      decoration:
                          !isPincodeFind ? TextDecoration.lineThrough : null))
            ],
          ),
        ),
      );
