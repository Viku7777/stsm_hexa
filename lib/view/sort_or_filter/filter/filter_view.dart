...
class _FilterViewState extends State<FilterView> {
  List<FilterModel> modellist =
      filterMethod.map((e) => FilterModel.fromJson(e)).toList();
          ...
          return InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: selectCategory.contains(e["name"])
                      ? Colors.transparent
          ...
          child: Column(
            ...
            children: [
              ...
              if (selectCategory.contains("Category") ||
                ...
                Wrap(
                    children: modellist[selectCategory.contains("Color")
                            ? 2
                            : selectCategory.contains("Price")
                                ? 3
                                : 4]
                        .type
                        .generate((index) {
                  return Padding(
                    ...
                    child: Chip(
                      label: Text(modellist[selectCategory.contains("Color")
                              ? 2
                              : selectCategory.contains("Price")
                                  ? 3
                                  : 4]
                      ...
                      side: BorderSide(color: AppColors.greythinColor),
